...
import { EXTENDED_UNITS } from './extended-lessons.js';
...
export const ALL_UNITS: readonly CurriculumUnitDraft[] = Object.freeze(
  [...LEVEL1_UNITS, ...LEVEL2_UNITS, ...EXTENDED_UNITS].sort((a, b) => a.unitNo - b.unitNo),
);
...
export const CURRICULUM_ALL_STATUS = {
  ...
  target: 250,
  levels: { topik1: LEVEL1_UNITS.length, topik2: LEVEL2_UNITS.length, topik3: 50, topik4: 50, topik5: 40, topik6: 40 },
} as const;
